...
class VoiceRecognitionPlugin: FlutterPlugin, MethodCallHandler,
  ...
  private val recognitionIntent = Intent().putExtra(RecognizerIntent.EXTRA_LANGUAGE_MODEL, RecognizerIntent.LANGUAGE_MODEL_FREE_FORM)
  ...
  private fun requestAudioPermission() {
    currentActivity?.let { ActivityCompat.requestPermissions(it, arrayOf(Manifest.permission.RECORD_AUDIO), REQUEST_RECORD_AUDIO_PERMISSION) }
  }
